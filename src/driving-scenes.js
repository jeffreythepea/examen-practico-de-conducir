...
export const DRIVING_SCENES = deepFreeze({
  'u-turn-photo-v1': {
    id: 'u-turn-photo-v1',
    asset: './assets/driving/u-turn-photo-v1.png',
  ...
  'overtaking-photo-v1': {
    ...
    asset: './assets/driving/overtaking-photo-v1.png',
    provenance: 'ai-generated-illustrative',
    alt: {
  ...
  'four-way-intersection-photo-v1': {
    ...
    asset: './assets/driving/four-way-intersection-photo-v1.png',
    provenance: 'ai-generated-illustrative',
    alt: {
  ...
  'roundabout-four-photo-v1': {
    ...
    asset: './assets/driving/roundabout-four-photo-v1.png',
    provenance: 'ai-generated-illustrative',
    alt: {
  ...
  'roundabout-five-photo-v1': {
    ...
    asset: './assets/driving/roundabout-five-photo-v1.png',
    provenance: 'ai-generated-illustrative',
    alt: {
  ...
  'parallel-parking-gap-photo-v1': {
    ...
    asset: './assets/driving/parallel-parking-gap-photo-v1.png',
    provenance: 'ai-generated-illustrative',
    alt: {
  ...
  'urban-roadside-photo-v1': {
    ...
    asset: './assets/driving/urban-roadside-photo-v1.png',
    provenance: 'ai-generated-illustrative',
    alt: {
